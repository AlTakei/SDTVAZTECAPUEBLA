                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="author_name" class="col-md-4 col-form-label text-md-right">Nombre y apellidos</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="numero_emplado" class="col-md-4 col-form-label text-md-right">Numero de empleado</label>
                            <div class="col-md-6">
                                <input id="numero_emplado" type="text" class="form-control @error('numero_emplado') is-invalid @enderror" name="numero_emplado" value="{{ old('numero_emplado') }}" required>
                                @error('numero_emplado')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="form-group row">
                            <label for="author_email" class="col-md-4 col-form-label text-md-right">Su correo electrónico</label>
                            <div class="col-md-6">
...
<script>
    ...
    Dropzone.options.attachmentsDropzone = {
        url: '{{ route('admin.create_tickets.storeMedia') }}',
        maxFilesize: 2, // MB
        addRemoveLinks: true,
        headers: {
