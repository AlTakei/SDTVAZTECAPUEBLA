...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.tickets.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('numero_emplado') ? 'has-error' : '' }}">
                <label for="numero_emplado">{{ trans('cruds.ticket.fields.numero_empleado') }}</label>
                <input type="text" id="numero_emplado" name="numero_emplado" class="form-control" value="{{ old('numero_emplado', isset($ticket) ? $ticket->numero_emplado : '') }}">
                @if($errors->has('numero_emplado'))
                    <em class="invalid-feedback">
                        {{ $errors->first('numero_emplado') }}
                    </em>
                @endif
            </div>
