        ...
        <table class="table table-bordered table-striped table-hover ajaxTable datatable datatable-Ticket">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.ticket.fields.numero_empleado') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
            ...
            <tbody>
                ...
                <tr data-entry-id="{{ $ticket->id }}">
                    ...
                    <td>
                        ...
                        @endcan
                        @can('ticket_edit')
                        <a href="{{ route('admin.tickets.edit', $ticket->id) }}" class="btn btn-xs btn-info">
                            Editar
                        </a>
                        @endcan
                        @can('ticket_delete')
                        <form action="{{ route('admin.tickets.destroy', $ticket->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}')">
...
<script>
    ...
    { data: 'numero_emplado', name: 'numero_emplado' },
