<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @can('inicio_access')
                <li class="nav-item">
                    <a href="{{ route("admin.home-pantalla.inicio") }}" class="nav-link {{ request()->is('admin/home-pantalla') || request()->is('admin/home-pantalla/*') ? 'active' : '' }}">
                        <i class="fa-fw fas fa-comment nav-icon">
            ...
            @can('ticket_create')
            <li class="nav-item">
                <a href="{{ route("admin.create_tickets.create") }}" class="nav-link {{ request()->is('admin/create_tickets')|| request()->is('admin/create_tickets/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-question-circle nav-icon"></i>
                    Crear Ticket
                </a>
            </li>
            {{-- <li class="nav-item">
                <a href="{{ route("admin.create_tickets.show", $ticket) }}" class="nav-link {{ request()->is('admin/create_tickets/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-question-circle nav-icon"></i>
                    Ver Ticket
                </a>
            </li> --}}
